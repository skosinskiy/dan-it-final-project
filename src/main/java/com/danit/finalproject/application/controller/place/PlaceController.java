...
public class PlaceController {
  ...
  @GetMapping
  public ResponseEntity<Page<PlaceResponse>> getAllPlacesByParam(
      @RequestParam(required = false) String searchParam, Pageable pageable) {
    return new ResponseEntity<>(placeFacade.getAllPlacesByParam(searchParam, pageable), HttpStatus.OK);
  }
