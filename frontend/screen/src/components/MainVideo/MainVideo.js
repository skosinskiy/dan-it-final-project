...
const MainVideo = (props) => {
  ...
  return (
    <div className={'MainVideo'} onClick={ (event) => { event.stopPropagation(); console.log(event) } }>
      ...
      <iframe autoplay className={'MainVideo__iframe'} title={'video'} src={`https://www.youtube.com/embed/${url}?version=3&autoplay=1&playlist=${url}&loop=1&controls=0&mute=1`} frameBorder="5"
